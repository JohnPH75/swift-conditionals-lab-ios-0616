...
*/
func  isGreater (intArgument1: Int, intArgument2: Int) -> Bool {
    
    if intArgument1 > intArgument2 {
...
//    isForceWith("Leia") == true
//    isForceWith("Anakin") == true
//    isForceWith("Obi Wan") == true
//    isForceWith("Yoda") == true
//    isForceWith("Vader") == true
//    
//    if isForceWith(name) == true{
//        
//        return true
//    }
//    else{
...
*/
func bankBalance (myBankBalance: Int, otherBankBalance: Int){
    
    if otherBankBalance >= 0 {
